...
for i in items:
    ...
    product_wish = i.select_one(".text").text
    sql = "INSERT INTO product (product_name, product_brand, product_price, product_wish) VALUES (%s, %s, %s, %s)"
    cur.execute(sql,(product_name, product_brand, product_price, product_wish))
    conn.commit() 
